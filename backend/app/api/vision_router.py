...
async def detect_v2_webcam_frame(
    ...
    """
    Real 35-Class YOLOv8 V2 Object Detection Endpoint for Live Web Camera Stream.
    Supports both multipart image upload and JSON Base64 image payload.
...
async def detect_direct_alias(
    ...
    return await detect_v2_webcam_frame(file=file, data=data, conf=conf, iou=iou)
